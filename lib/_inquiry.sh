...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Canal TalkLex que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Canal TalkLex, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Canal TalkLex\n"
  printf "   [1] Atualizar Canal TalkLexP\n"
  printf "   [2] Deletar Canal TalkLex\n"
  printf "   [3] Bloquear Canal TalkLexP\n"
  printf "   [4] Desbloquear Canal TalkLex\n"
  printf "   [5] Alter. dominio Canal TalkLex\n"
  printf "\n"
  read -p "> " option
